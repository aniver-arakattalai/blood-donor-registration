...
<head>
    ...
    <title>Aaniver Arakattalai - Blood Donor Registration</title>
    
    <!-- Social Media Meta Tags for Thumbnail -->
    <meta property="og:title" content="Join Aaniver Arakattalai - Save Lives Through Blood Donation">
    ...
    <meta name="twitter:title" content="Join Aaniver Arakattalai - Save Lives Through Blood Donation">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="https://forms.gle/Zc8QEsRwbiR5AZDj7" class="cta-button" target="_blank">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.cta-button').addEventListener('click', function() {
                ...
                console.log('Aaniver Arakattalai blood donor registration clicked');
            });
